...
\figur{1}{Design/Sekvensdiagram_UC1}{Sekvensdiagram for use case 1}{SD_UC1}

\subsection*{Search}
Sekvensdiagrammet vist i figur \ref{SD_UC2} beskriver forløbet for når en bruger ønsker at søge efter en quiz eller gruppe .

\figur{1}{Design/Sekvensdiagram_UC2}{Sekvensdiagram for use case 2}{SD_UC2}
...
\figur{1}{Design/Sekvensdiagram_UC3}{Sekvensdiagram for use case 3}{SD_UC3}
...
\figur{1}{Design/Sekvensdiagram_UC4}{Sekvensdiagram for use case 4}{SD_UC4}
...
\figur{1}{Design/Sekvensdiagram_UC5}{Sekvensdiagram for use case 5}{SD_UC5}
...
\figur{1}{Design/Sekvensdiagram_UC6}{Sekvensdiagram for use case 6}{SD_UC6}

\subsection*{Logout}
Sekvensdiagrammet vist i figur \ref{SD_UC7} beskriver forløbet for når en bruger ønsker at logge ud af systemet.

\figur{1}{Design/Sekvensdiagram_UC7}{Sekvensdiagram for use case 7}{SD_UC7}
...
\figur{1}{Design/Sekvensdiagram_UC8}{Sekvensdiagram for use case 8}{SD_UC8}
...
\figur{1}{Design/Sekvensdiagram_UC9}{Sekvensdiagram for use case 9}{SD_UC9}
...
\figur{1}{Design/Sekvensdiagram_UC10}{Sekvensdiagram for use case 10}{SD_UC10}
...
\figur{1}{Design/Sekvensdiagram_UC11}{Sekvensdiagram for use case 11}{SD_UC11_Part1}
...
\figur{1}{Design/Sekvensdiagram_UC11_Part2}{Sekvensdiagram for use case 11}{SD_UC11_Part2}