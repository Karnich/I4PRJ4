...
\figur{1.0}{Design/UC1class}{Klassediagram for use case 1}{Label}

\subsubsection{Klassediagram for FindQuiz}

\figur{1.0}{Design/UC2class}{Klassediagram for use case 2}{Label}


\subsubsection{klassediagram for AnswerQuiz}

\figur{1.0}{Design/UC3class}{Klassediagram for use case 3}{Label}
